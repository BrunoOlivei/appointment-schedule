...
from app.schemas.base import BaseInDB, BaseUpdate
from app.actions.constants import GET_MULTI_DEFAULT_SKIP
...
class ActionsBase:
    ...
    async def update(
        ...
        *,
        ...
        existing_obj_to_update: Optional[
            ModelType
        ] = db_obj_to_update or await self.get(
            session,
